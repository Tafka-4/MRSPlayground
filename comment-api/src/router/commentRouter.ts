...
import { createComment, getComments, getComment, updateComment, deleteComment, likeComment, dislikeComment, getCommentsWithPagination } from '../controller/commentController.js';
