...
import { createGallery, getGallery, getGalleryList, updateGallery, deleteGallery, subscribeGallery, unsubscribeGallery, galleryAdminChange, galleryManagerAdd, galleryManagerDelete, galleryThumbnailUpload, galleryThumbnailDelete, addGalleryBlockUser, deleteGalleryBlockUser, addGalleryBlockIP, deleteGalleryBlockIP } from '../controller/galleryController.js';
...
router.post('/:galleryId/block-user', loginRequired, asyncWrapper(addGalleryBlockUser));
router.delete('/:galleryId/block-user', loginRequired, asyncWrapper(deleteGalleryBlockUser));
router.post('/:galleryId/block-ip', loginRequired, asyncWrapper(addGalleryBlockIP));
router.delete('/:galleryId/block-ip', loginRequired, asyncWrapper(deleteGalleryBlockIP));
