...
export const likeEpisode = async (req: Request, res: Response) => {
  ...
  res.status(200).json({ message: 'Episode liked successfully', likeCount, dislikeCount });
};
...
export const dislikeEpisode = async (req: Request, res: Response) => {
  ...
  res.status(200).json({ message: 'Episode disliked successfully', likeCount, dislikeCount });
};
